...
import { StyleSheet, View, TextInput, Button, ActivityIndicator, ScrollView, Alert } from 'react-native';
import { ThemedText } from '../../components/ThemedText';
import { ThemedView } from '../../components/ThemedView';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { router } from 'expo-router';
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <ThemedView style={styles.form}>
          ...
          {isLoading ? (
            ...
            <Button title="Register" onPress={handleSubmit} color='#3E7B27s' />
          )}
        </ThemedView>
      </ScrollView>
    </ThemedView>
...
// Update the styles object at the bottom of the file:
const styles = StyleSheet.create({
  container: {
    flex: 1,
  ...
  title: {
    fontSize: 50, // Increased to match pageZero
    fontWeight: 'bold',
    marginBottom: 24,
    textAlign: 'center',
    color: '#3E7B27', // Updated to match green from pageZero
  },
  infoBox: {
    padding: 14,
    borderRadius: 8,
    ...
    alignItems: 'center',
    borderWidth: 1,
    borderColor: '#85A947', // Updated to match green theme
  ...
  label: {
    marginBottom: 8,
    fontWeight: '600',
    color: '#EFE3C2', // Updated to match light text color from pageZero
    fontSize: 16,
  },
  input: {
    borderWidth: 1,
    ...
    marginBottom: 20,
    fontSize: 16,
    color: '#EFE3C2', // Updated text color
    backgroundColor: '#000000', // Dark background
  },
  errorText: {
    color: '#ff4444', // Brighter red for better visibility on dark background
    marginBottom: 16,
    fontWeight: 'bold',
  },
  loadingText: {
    marginTop: 16,
    fontSize: 16,
    color: '#EFE3C2', // Updated to match light text color
  },
});